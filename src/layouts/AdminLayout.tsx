...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div
        className={`transition-all duration-300 ease-in-out pt-16 lg:pt-0 ${isSidebarCollapsed ? "lg:ml-20" : "lg:ml-64"}`}
      >
            ...
            <div className="relative z-10 p-4 sm:p-6">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl font-bold text-slate-100 mb-1">Estado del Sistema</h2>
                    <p className="text-xs sm:text-sm text-slate-400">Monitoreo en tiempo real del Servidor</p>
                  </div>
                </div>

                <div className="w-full lg:max-w-md">
                  <Suspense fallback={<div className="h-8 sm:h-10 bg-gray-700/30 rounded-lg animate-pulse"></div>}>
